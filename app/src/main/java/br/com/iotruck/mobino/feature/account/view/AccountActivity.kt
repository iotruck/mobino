...
class AccountActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tvName : TextView = findViewById(R.id.et_nameAccount)
        val tvBirth : TextView = findViewById(R.id.et_birthAccount)
        val tvliscence : TextView = findViewById(R.id.et_liscenceAccount)
        val tvCpf : TextView = findViewById(R.id.et_cpfAccount)
